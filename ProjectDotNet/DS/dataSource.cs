    ...
    public class dataSource
    {
        ...
        public static List<BE.Guest> guests = new List<BE.Guest>()
        {
            new BE.Guest()
            {
                ...
                EntryDate=new DateTime(2020,03,15),
                ReleaseDate=new DateTime(2020,03,17),
                 ...
                 new BE.Guest()
            {
                ...
                EntryDate=new DateTime(2020,05,15),
                ReleaseDate=new DateTime(2020,05,17),
                ...
                new BE.Guest()
            {
                ...
                EntryDate=new DateTime(2020,01,15),
        ...
        public static List<BE.Order> orders = new List<BE.Order>
        {
             ...
             new BE.Order()
            {
                ...
                OrderKey=BE.configurition.GetOrderKey(),
                Status=BE.enums.OrderStatus.mail_has_been_sent,
